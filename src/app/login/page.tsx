...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12 max-w-md w-full border border-white/20">
        {/* Header */}
        ...
        {/* Form */}
        <form onSubmit={isLogin ? handleLogin : handleCreateAccount} className="space-y-5">
          {/* Username Input */}
          <div>
